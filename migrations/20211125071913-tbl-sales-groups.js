...
exports.up = function (db) {
  return db.createTable('tbl_sales_groups', {
    ...
    mail_template_id: { type: 'string', notNull: false },
    ticket_type_id: { type: 'string', notNull: false },
    facility_type: { type: 'string', notNull: false },
    group_number: { type: 'string', notNull: false },
  });
};

exports.down = function (db) {
  return db.dropTable('tbl_sales_groups');
};
